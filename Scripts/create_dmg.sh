...
VOLUME_NAME="GigE Virtual Camera"
...
echo ""
echo "Next steps:"
echo "1. Test the DMG by mounting it: open $OUTPUT_DIR/$DMG_NAME"
echo "2. For distribution, notarize the DMG: ./Scripts/notarize.sh $OUTPUT_DIR/$DMG_NAME"
echo "3. Share the notarized DMG with users"
echo ""
